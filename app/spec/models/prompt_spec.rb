...
RSpec.describe Prompt, type: :model do
  ...
  it "it converts to INTEGER if an Integer is passed as string for original_index" do
    subject.original_index = "11"
    expect(subject).to be_valid
    expect(subject.original_index).to be(11)
  end

  it "is not valid when a Non-Integer number for original_index is given" do
    subject.original_index = 9999999999999999999.3
    expect(subject).not_to be_valid
  end
